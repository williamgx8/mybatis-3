...
public class ResultLoaderMap {
	 ...
	 * 往loaderMap中添加待加载的内容
	 *
	 * @param property 待加载字段名
	 * @param metaResultObject 待加载字段所属的对象
	...
	public static class LoadPair implements Serializable {
		...
		private LoadPair(final String property, MetaObject metaResultObject,
			...
			if (metaResultObject != null && metaResultObject
				...
				if (mappedStatementParameter instanceof Serializable) {
					...
					this.configurationFactory = resultLoader.configuration
		...
		public void load(final Object userObject) throws SQLException {
			if (this.metaResultObject == null || this.resultLoader == null) {
				...
				this.resultLoader = new ResultLoader(config, new ClosedExecutor(), ms,
			...
			//延迟加载器加载数据，并将加载的内容设置到对象的property属性上
		...
		private Configuration getConfiguration() {
			...
			try {
				final Method factoryMethod = this.configurationFactory
					.getDeclaredMethod(FACTORY_METHOD);
				...
				if (!factoryMethod.isAccessible()) {
					configurationObject = AccessController
