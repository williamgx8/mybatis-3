...
import org.apache.ibatis.reflection.typeparam.Animal;
...
import org.apache.ibatis.reflection.typeparam.Person;
...
public class TypeParameterResolverTest {
	...
	public void testReturn_Lv2ArrayOfList() throws Exception {
		...
		ParameterizedType paramType = (ParameterizedType) genericArrayType
	...
	public void fun1() throws NoSuchMethodException {
		Class<?> srcType = Person.class;
		Class<?> declaringClass = Animal.class;

		Method method = srcType.getMethod("getName",String.class);
		...
		Method superMethod = declaringClass.getMethod("getName", Object.class);
		for (Type type : TypeParameterResolver.resolveParamTypes(superMethod, srcType)) {
			System.out.println(type.getTypeName());
		}
	}
